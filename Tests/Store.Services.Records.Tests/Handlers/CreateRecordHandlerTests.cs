...
namespace Store.Services.Records.Tests.Handlers
{
    public class CreateRecordHandlerTests
    {
        ...
        public async Task HandleCreateRecordRequest_WithCorrectRequest_CreatesRecord()
        {
            ...
            _recordService.Setup(x => x.AddRecordAsync(It.IsAny<Record>(), CancellationToken.None));
            ...
            var handler = new CreateRecordCommandHandler(_recordService.Object, _cacheService.Object, _mediator.Object, _currentUser.Object);
            ...
            _recordService.Verify(x=>x.AddRecordAsync(It.IsAny<Record>(), CancellationToken.None), Times.Once);
